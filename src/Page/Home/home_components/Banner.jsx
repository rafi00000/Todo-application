...
const Banner = () => {
  ...
  return (
    <div className="space-y-3 flex flex-col justify-center items-center py-32 relative border">
      <h1 className="text-4xl md:text-6xl font-bold text-center w-4/5 mx-auto">
        Turning dreams into plans, one task at a time.
      </h1>
      <p className="text-center">
        <button onClick={handleExplore} className="btn bg-white border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white">
          Let's Explore
        </button>
      </p>
      <div className="">
