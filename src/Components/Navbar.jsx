  ...
  return (
    <div className="bg-violet-300 p-5 flex justify-around items-center">
      ...
      <div className="flex gap-5">
        ...
        <NavLink to="/about" className={({ isActive }) => isActive ? "text-violet-700 font-bold underline rounded-md" : "text-black"}>About</NavLink>
        <NavLink to="/contacts" className={({ isActive }) => isActive ? "text-violet-700 font-bold underline rounded-md" : "text-black"}>Contacts</NavLink>
